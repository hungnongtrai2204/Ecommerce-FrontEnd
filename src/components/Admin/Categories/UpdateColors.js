...
import { fetchColorAction, updateColorAction } from "../../../redux/slices/categories/colorsSlice";
...
export default function UpdateColor() {
  ...
  const {color:{ color},loading,error,isUpdated} = useSelector(state=>state?.colors);
  console.log(color);
  //---form data---
