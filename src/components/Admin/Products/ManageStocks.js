            ...
            <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
              ...
              <div className="mt-8 sm:flex sm:items-center">
                <div className="sm:flex-auto">
                  ...
                  <p className="mt-2 text-sm text-gray-700">
                    List of all the products in your account including their
                    name, title,
                  </p> */}
                </div>
                <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                  {pagination?.pre ? (
                    <button
                      ...
                      className="mr-4 inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
