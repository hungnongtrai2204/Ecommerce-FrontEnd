...
export default function ProductsFilters() {
  ...
  if (sortOptions) {
    ...
    for (let sort of sortOptions) {
      if (sort.current) {
        productUrl = `${productUrl}&sort=${sort.name}`;
      }
    }
  }
  ...
  }, [dispatch, category, brand, color, price, size, page, sortOptions]);
