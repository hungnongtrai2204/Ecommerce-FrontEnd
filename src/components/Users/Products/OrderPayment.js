                  ...
                  <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                    ...
                    {orderLoading ? (
                      ...
                      <button
                        ...
                        className="mt-5 w-full rounded-md border border-transparent bg-green-600 py-3 px-4 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-50"
                      >
                        Confirm COD - ${sumTotalPrice}
                      </button>
                    )}
                  </div>
                </div>
